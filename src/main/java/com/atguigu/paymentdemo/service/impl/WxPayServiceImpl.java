...
public class WxPayServiceImpl implements WxPayService {
    ...
    public Map<String, Object> nativePay(Long productId) throws Exception{
        ...
        amountMap.put("currency", "CNY"); //RMB
    ...
    public void processOrder(Map<String, Object> bodyMap) throws GeneralSecurityException {
        ...
        if(lock.tryLock()){
            try {
                //处理重复的通知
                //接口调用的幂等性：无论接口被调用多少次，产生的结果是一一致的
...
//                }
    ...
    public String queryOrder(String orderNo) throws Exception {
        ...
        try {
            ...
            if (statusCode == 200) { //处理成功
                ...
                log.info("Native查询订单失败,响应码 = " + statusCode+ ",返回结果 = " + bodyAsString);
                throw new IOException("request failed");
            }
    ...
    /**
     * 根据订单号查询微信支付查单就扣核实订单状态
     * 如已支付，更新商户端订单状态
     * 如果未支付，则调用关单接口关闭订单更新商户端状态
     * @param orderNo
     */
    @Override
    ...
    /**
     * 下载账单
     * @param billDate 本接口url来自上个接口的url 上面请求下载返回的url只能在此接口下载
     * @param type
     * @return
     * @throws Exception
     */
    ...
    private void closeOrder(String orderNo) throws Exception {
        ...
        //创建远程对象的过程
        String url = String.format(WxApiType.CLOSE_ORDER_BY_NO.getType(),orderNo);//替换占位符 %
        url = wxPayConfig.getDomain().concat(url);
        HttpPost httpPost = new HttpPost(url);
